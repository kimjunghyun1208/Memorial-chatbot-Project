...
# style_extractor.py 내 경로 수정
# 현재 위치: .../src/core/persona_process/
# 3번 상위 디렉토리로 이동해야 프로젝트 루트 (Memorial-chatbot-Project/)에 도달합니다.
BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
 
# ENV_PATH: Memorial-chatbot-Project/config/.env
